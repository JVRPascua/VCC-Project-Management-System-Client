...
const ProjectTasks = ({ setCurrentId, currentId }) => {
    ...
    const projectTasksBacklogs = projectTasks?.filter(task=>{
        const notDone = task.is_done=true;
    ...
    return ( 
            ...
            <Grid key={1} item >
                <AppBar className={classes.appBar} position="static" color="inherit">
                    <Typography className={classes.heading} variant="h4" align="left">{projectTasksBacklogs.length} Backlogs</Typography>
                </AppBar>
            ...
            <Grid key={2} item>
                <AppBar className={classes.appBar} position="static" color="inherit">
                    <Typography className={classes.heading} variant="h4" align="left">{projectTasksActive.length} Active Tasks</Typography>
                </AppBar>
              <Paper className={classes.paper} elevation={6} sx={{ overflowY: "scroll"}}>
